...
<html>
<head>
<title>DSP_ENCRYPT_DECRYPT</title>
...
echo '<p>insert the encrypted information into the database with this code.</p>'; }

?>
<form method="post">
<div class="form-group">
<div class="well"><h2>KSU Form</h2>
</div>
